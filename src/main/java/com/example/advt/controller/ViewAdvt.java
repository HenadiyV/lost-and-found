   ...
   int  found1;
    ...
    public String thingSearch( Principal principal,SearchDto search,
        ...
        try {
            ...
            boolean sear=false;
            boolean stat=false;
            if(search_temp!=null){tem=true;}
            if(search.getCity()!=null){sear=true;}
            if(search.getSubcategory()!=null){sear=true;}
            ...
            if(search.getFound()>0){stat=true;}
            int cit=0;
            if(search.getCity()!=null){cit=search.getCity().getId();}
